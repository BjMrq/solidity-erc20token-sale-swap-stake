...
module.exports = async function (deployer) {
    ...
    await deployer.deploy(SatiTokenSale, satiToEthRate, deployerAddress, SatiToken.address, KYCValidation.address);
    ...
    await deployer.deploy(SatiEthSwap, SatiToken.address, mockPriceFeedEth.address);
    //ERC20
    deployer.deploy(ERC20Token, 10000000000, deployerAddress);
    const mockPriceFeedERC20 = await MockPriceFeed.new(8, "17334433080000000000", 1, 1, 1);
    await deployer.deploy(SatiSwapTokenSwap, SatiToken.address, mockPriceFeedERC20.address, mockPriceFeedERC20.address);
