...
// import { EthQuoteSwapInstance, SatiTokenInstance } from "../types";

// const SatiToken = artifacts.require("SatiToken");
// const EthQuoteSwap = artifacts.require("EthQuoteSwap");
...
//   const swapInstance = await EthQuoteSwap.new(
...
//       await swapInstance.swapBaseForQuoteToken(ethAmountToEmptySupply, {
